# In Python, .pyc files are auto-generated compiled bytecode versions of .py
# files that are used to speed up execution by avoiding recompilation, and 
# Python runs them instead of the .py files if they are up-to-date.
